package com.sofija.aquaeater.config;
...
public final class GameConfig {
    ...
    public static final float PLAYER_HEIGHT = 90f;
    public static final float BOOSTER_WIDTH = 110f;
    public static final float BOOSTER_HEIGHT = 80f;
    public static final float PLAYER_SPEED = 350f;
    public static final float FISH_SPEED = 420f;
    public static final float SPAWN_MARGIN = 150f;
